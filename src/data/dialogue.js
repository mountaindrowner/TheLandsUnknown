...
(function (TLU) {
  ...
  const ARCHETYPES = {
    innkeeper: {
      ...
      greet: [
        ...
        '"A bed, a bowl, and a barred door — that\'s all the Churn allows."',
        '"Sit, sit. You look like the road chewed you and spat you out."',
        '"We don\'t get many of the Kindled through here. Drinks are half-price for the brave."',
      ],
      talk: [
        '"My grandmother rode out a Churn in the open once. Came back white-haired and humming songs no one knew."',
        '"Charge\'s gone dear this season. The gem-merchants hoard it like dragons."',
        ...
        '"There\'s an old saying: \'Remember the dead, outlast the Churn.\' The Kindled lived by it, before the fall."',
        '"My boy wants to be a soldier. I tell him soldiers feed the Churn. He doesn\'t listen."',
        '"Echoes gather where the dead were wronged. We keep a candle lit so ours stay kind."',
        '"Drink up. Tomorrow the wilds will try to kill you, same as today."',
        '"They say the spire-cities float on stored Charge. I\'ll believe it when one doesn\'t fall."',
      ],
    ...
    merchant: {
      ...
      talk: [
        '"A charged Sapphire holds Charge for a year. A cracked one? An afternoon, if you\'re lucky."',
        ...
        '"Prices rise the closer you get to the Churnreach. So does the chance of dying. Funny, that."',
      ...
      bye: ['"Pleasure doing business. Try not to die owing me."', '"Spend it before the Churn takes it."'],
    },
    trainer: {
      ...
      greet: [
        ...
        '"The Kindled trained for ten years before they bonded an echo. You\'ve got less time. Pay attention."',
      ],
      talk: [
        ...
        '"An Attunement is just a muscle you can\'t see. Use it or lose it, same as any."',
        '"I trained a Skyrender once. She could stop a falling man mid-air. The Churn took her anyway."',
    ...
    guard: {
      ...
      talk: [
        ...
        '"If you see a Cragwrought walking the undone lands, you run. You don\'t fight it. You run."',
        '"The Wardens want us to march east. March east into what? Nobody comes back from Dawnhollow."',
        '"Keep to the roads. The roads are watched. The wilds are not."',
      ],
      bye: ['"Stay out of trouble."', '"Storm\'s coming. It always is."'],
    },
    scholar: {
      role: 'Warden Scholar', glyph: '◈', color: '#d9a7ff',
      greet: [
        '"Ah — a mind, perhaps? Or just another sword? Either is useful, in its way."',
        '"You carry echoes. Do you know what that means? Few do, anymore."',
        '"I study the old Orders. The dead ones. They have so much to teach, if you can stand the silence."',
      ],
      talk: [
        '"There were ten Attunements and ten Orders, once. Now there are echoes, and people like you who don\'t know what you are."',
        ...
        '"Charge is breath made visible. The Churn exhales; we inhale. We are, all of us, borrowing the Churn\'s lungs."',
        '"If you gather the four fragments, bring them to me. Or to the Churn. Or to your own ruin — the result may be the same."',
      ],
      bye: ['"Go carefully. Knowledge is heavy, and you carry enough already."', '"Remember the dead, Kindled."'],
    },
    wanderer: {
      ...
      talk: [
        ...
        '"Met a man who\'d been to the Churnreach and back. He didn\'t talk right after. Words came out sideways."',
        '"Everyone\'s running from something. Me? I\'m running from sitting still."',
        '"Found a dead Kindled in the Ashlands. Armor still glowing faint. I couldn\'t move it. Couldn\'t leave it, either. Stayed a while. Then left."',
      ],
    ...
    urchin: {
      ...
      talk: [
        '"My friend Teft says if you breathe in enough Charge you can FLY. He\'s a liar but I believe him."',
        '"The guards chase me but I\'m faster. I know every roof in the hold."',
        '"I saw an echo once. It looked at me. Then it followed the baker home. Bakers always get the good echoes."',
        '"When I grow up I\'m gonna be one of the Kindled and nobody\'s gonna chase me ever again."',
      ],
      bye: ['"Bye mister! Don\'t die!"', 'The child is already gone, quick as an echo.'],
    },
    priest: {
      role: 'Ashpriest', glyph: '†', color: '#b9a7ff',
      greet: [
        '"The Churn gives and the Churn takes. Have you given today?"',
      ...
      talk: [
        '"We do not pray to the Churn. We pray with it. There is a difference, and it is everything."',
        '"The Hollowed worship the dark behind the Churn. We do not speak their name in the light."',
        '"Death is only the wind changing direction. So my order teaches. I find it comforting on most days."',
        '"Bring your dead to the eastern wall. Let the Churn carry them home. It is the only honest funeral."',
        '"You will face the Gloammother, I think. When you do — do not listen to her. She wears voices like cloaks."',
      ],
      bye: ['"Go with the wind at your back."', '"The Churn keep you, child of the light."'],
    },
    smith: {
      ...
      talk: [
        '"Real Riftsteel hums when the Churn\'s near. I\'ve a bar that sings before every gale. Better than any bell."',
        '"They say the old smiths drew bright metal straight from a humming cell. Lost art. We just hammer and sweat now."',
  ...
  const RUMORS = [
    ...
    'A merchant swears the Churnreach has gone quiet. Quiet storms are the worst kind.',
    'The Cinder Reavers burned a caravan on the western road. Warlord Varen wants the Kindled dead, they say.',
    ...
    'A Cragwrought Colossus was seen walking the undone lands. It left no tracks. Stone leaves no tracks.',
    'Somebody dredged a singing blade from a flooded vault and went mad inside a week.',
    'The eastern holds whisper of a "last storm" coming. The Wardens whisper back to be ready.',
    'A wanderer claims the dead in the Ashlands stand up when the wind blows east.',
    'They found a Kindled\'s glowing plate in a crater, empty, with no body inside it.',
    'Gem-prices doubled overnight in three holds. Someone is buying up all the Charge. For what?',
    ...
    'Travelers on the churn-roads report a woman\'s voice in the wind that knows their names.',
  ];
  ...
  const BARKS = [
    ...
    'The ironbuds close their shells as your shadow falls across them.',
    'A flock of windrays ribbons across the clouds, fleeing something unseen.',
    ...
    'Your echoes cluster tighter, the way they do when the world feels thin.',
  ...
  const EVENTS = [
    { id: 'wisp_gift', weight: 3, text: 'A bright echo alights on your hand and bursts, pouring warmth into you.',
      effect: function (g) { const p = g.player; const s = Math.min(p.maxCharge - p.charge, 25); p.charge += s; g.msg('%cThe echo\'s gift: +' + s + ' Charge.', 'good'); } },
    ...
    { id: 'shrine', weight: 2, text: 'A weathered shrine to the Churn. You leave a coin and feel, briefly, watched-over.',
  ...
  const LANDMARKS = [
    ...
    { kind: 'shrine', name: 'A Sunken Shrine', glyph: '⩩', color: '#d9a7ff',
      lore: 'A shrine half-drowned in a still black pool. You cannot read the script, but the air is thick with Charge, and breathing deepens it.',
      reward: { type: 'charge' } },
    { kind: 'battlefield', name: 'The Quiet Field', glyph: '‡', color: '#c0533b',
      lore: 'An old battlefield the Churn never fully cleared. Rusted blades stand in the ironbud like a crop of iron. Some of the dead still clutch what they died for.',
    ...
    { kind: 'crater', name: 'A Fallen Star', glyph: '✦', color: '#ffd86b',
      ...
      reward: { type: 'material', kind: 'alloy' } },
  ...
  const CODEX = {
    world: [
      { id: 'aurenmark', title: 'Aurenmark', text: 'The sundered continent. Once green, now scoured by the Churn that walks it east to west. Spire-cities float on stored Charge; the rest endure behind windward walls.' },
      { id: 'Churn', title: 'The Churn', text: 'A living tempest that crosses the world on its own schedule. It wakes the stones, scatters the dead eastward, and floods the air with Charge — the breath that powers every Attunement and cell.' },
      { id: 'gleam', title: 'Charge', text: 'Stored soul-light. Breathed in from charged gemstones, it fuels channeling and mends Riftplate. Spend it wisely; it drains with use and time.' },
      { id: 'echoes', title: 'Echoes', text: 'Fragments of living spirit drawn to strong emotion and old vows. They gather at the shoulders of those the dead Orders would have chosen. Yours followed you out of exile.' },
      { id: 'orders', title: 'The Kindled', text: 'The reborn Orders of knights — Skyrender, Stonewarden, Slipstrider, Veilseer, Cinderwright. Each bonds an echo and binds two Attunements. You are, perhaps, the first of a new age of them.' },
    ...
    factions: {
      coalition: 'The Wardens — scholars and soldiers who would unite the holds against the Churn and the waking dark. They sense the echoes that follow you, and they remember the old vows.',
      reavers:   'The Cinder Reavers — raiders who worship the Churn\'s violence and take what the weak cannot keep. Their warlord, Varen, hunts the Kindled with a stolen Riftspur.',
      guild:     'The Deepdelvers — treasure-hunters and tomb-robbers who plumb the drowned Riftvaults for lost wonders and lost Charge. They pay well and ask few questions.',
      cult:      'The Hollowed — a hidden cult who worship the dark behind the Churn and labor to wake the Hollow Ones. They mark their shrines with a black sun.',
    },
    places: {
  ...
  const BESTIARY_LORE = {
    scrapmite: 'Rockmites — palm-sized shelled scavengers that swarm where the dead lie. Harmless alone; a tide of them can strip a corpse to bone in an hour.',
    palefang_whelp: 'The young of the palefang, a pale armored predator. Even hatchlings have a killing bite. The adults do not bear thinking about.',
    reaver_thug: 'The Cinder Reavers\' rank and file — desperate, brutal, and many. They fight for plunder and the Churn\'s favor.',
    ridgehound: 'Ridgehounds — six-legged pack hunters with chitinous, axe-like jaws. They run down anything that flees.',
    craghorn: 'Craghorns — vast, slow, shelled beasts. Domesticated as draft animals in the holds; lethal in the wild when cornered.',
    reaver_raider: 'Seasoned Cinder Reavers, armed with stolen steel. They cleave through the unprepared and laugh in the Churn.',
    gloamspawn: 'Gloamspawn — congealed darkness given hunger and shape. A lesser splinter of the Hollow Ones\' power. It drinks souls to mend itself.',
    deepmaw: 'Deepmaws lurk in flooded vaults, all jaw and patience. They swallow the careless whole.',
    churncaller: 'Churncallers — those who gave themselves to the Churn\'s dark form. They wield the gale as a weapon and no longer remember their names.',
    cragwrought: 'A Cragwrought Colossus — stone given malevolent life, the Churn\'s fist made flesh. Do not fight it if you can run. Often, you cannot.',
    hollow_knight: 'A Hollow Knight — a fallen Kindled remade by the dark, bound in deathless service. It regenerates from the rift itself.',
    hollow_splinter: 'A splinter of a Hollow One — a fragment of an old god\'s malice. Where it walks, the dead grow restless and the living grow afraid.',
    highlord_reaver: 'Varen, Warlord of Cinders — the man uniting the Reaver bands beneath one black banner. He carries a stolen Riftspur and hunts the Kindled for sport.',
    gloammother: 'Vethra, the Gloammother — eldest of the waking Hollow Ones. A thing of living darkness that births murderous shadows to mimic and murder. She wears voices like cloaks. Do not listen.',
    churnheart: 'Karth-Vael, the Heart of the Churn — the first Hollow One, and the engine of the undoing itself. It does not wake; it has never slept. To stand before it is to stand at the wound in the centre of the world. To end it is to end the Churn forever.',
  };
