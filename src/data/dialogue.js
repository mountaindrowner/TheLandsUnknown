...
(function (TLU) {
  ...
  const ARCHETYPES = {
    innkeeper: {
      ...
      talk: [
        ...
        '"Anima\'s gone dear this season. The gem-merchants hoard it like dragons."',
        ...
        '"They say the spire-cities float on stored Anima. I\'ll believe it when one doesn\'t fall."',
      ],
    ...
    merchant: {
      ...
      talk: [
        '"A charged Sapphire holds Anima for a year. A cracked one? An afternoon, if you\'re lucky."',
    ...
    guard: {
      ...
      talk: [
        ...
        '"If you see a Cragwrought walking the unmade lands, you run. You don\'t fight it. You run."',
    ...
    scholar: {
      ...
      talk: [
        '"There were ten Arts and ten Orders, once. Now there are echoes, and people like you who don\'t know what you are."',
        ...
        '"Anima is breath made visible. The Churn exhales; we inhale. We are, all of us, borrowing the Churn\'s lungs."',
    ...
    urchin: {
      ...
      talk: [
        '"My friend Teft says if you breathe in enough Anima you can FLY. He\'s a liar but I believe him."',
  ...
  const RUMORS = [
    ...
    'A Cragwrought Colossus was seen walking the unmade lands. It left no tracks. Stone leaves no tracks.',
    ...
    'Gem-prices doubled overnight in three holds. Someone is buying up all the Anima. For what?',
  ...
  const CODEX = {
    world: [
      { id: 'aurenmark', title: 'Aurenmark', text: 'The sundered continent. Once green, now scoured by the Churn that walks it east to west. Spire-cities float on stored Anima; the rest endure behind windward walls.' },
      { id: 'Churn', title: 'The Churn', text: 'A living tempest that crosses the world on its own schedule. It wakes the stones, scatters the dead eastward, and floods the air with Anima — the breath that powers every surge and gem.' },
      { id: 'gleam', title: 'Anima', text: 'Stored soul-light. Breathed in from charged gemstones, it fuels channeling and mends Riftplate. Spend it wisely; it drains with use and time.' },
      ...
      { id: 'orders', title: 'The Kindled', text: 'The reborn Orders of knights — Skyrender, Stonewarden, Slipstrider, Veilseer, Cinderwright. Each bonds an echo and binds two Arts. You are, perhaps, the first of a new age of them.' },
    ...
    factions: {
      ...
      reavers:   'The Cinder Reavers — raiders who worship the Churn\'s violence and take what the weak cannot keep. Their warlord, Varen, hunts the Kindled with a stolen Riftshard.',
      guild:     'The Deepdelvers — treasure-hunters and tomb-robbers who plumb the drowned Riftvaults for lost wonders and lost Anima. They pay well and ask few questions.',
  ...
  const BESTIARY_LORE = {
    ...
    stormform: 'Churncallers — those who gave themselves to the Churn\'s dark form. They wield the gale as a weapon and no longer remember their names.',
    thunderclast: 'A Cragwrought Colossus — stone given malevolent life, the Churn\'s fist made flesh. Do not fight it if you can run. Often, you cannot.',
    voidechoes_knight: 'A Hollow Knight — a fallen Kindled remade by the dark, bound in deathless service. It regenerates from the void itself.',
