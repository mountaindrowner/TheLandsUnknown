...
(function (TLU) {
  ...
  const MAIN = {
    ...
    stages: [
      { id: 'awaken', text: 'Speak with the Galewardens at the nearest hold. They sense the wisps that follow you.', trigger: { type: 'talk', who: 'stormwarden' } },
      ...
      { id: 'final', text: 'Stand in the last storm. Destroy the Gloammother.', trigger: { type: 'kill', who: 'midnight_mother' } },
    ],
  ...
  const SIDE = [
    ...
    { id: 'bounty_thunderclast', name: 'The Walking Ruin', faction: 'coalition',
      stages: [{ id: 'slay', text: 'Slay a Cragwrought Colossus haunting the storm-lands.', trigger: { type: 'killType', who: 'thunderclast' } }],
