...
(function (TLU) {
  ...
  // The spine. Completing it culminates in the final boss beneath Dawnhollow.
  const MAIN = {
    ...
    stages: [
      ...
      { id: 'reaver', text: 'The Cinder Reavers raid the roads, hoarding a stolen Riftspur. End Warlord Varen.', trigger: { type: 'kill', who: 'highlord_reaver' } },
      { id: 'gather', text: 'Four Rift fragments lie scattered. Recover them all from the deep vaults.', trigger: { type: 'fragments', count: 4 } },
      { id: 'deepvault', text: 'Vethra, the Gloammother, wakes beneath ruined Dawnhollow. Descend and end her.', trigger: { type: 'reach', place: 'deepvault' } },
      { id: 'final', text: 'Stand in the last Churn. Destroy the Gloammother.', trigger: { type: 'kill', who: 'gloammother' } },
    ],
  ...
  const SIDE = [
    ...
    { id: 'bounty_cragwrought', name: 'The Walking Ruin', faction: 'coalition',
      stages: [{ id: 'slay', text: 'Slay a Cragwrought Colossus haunting the undone lands.', trigger: { type: 'killType', who: 'cragwrought' } }],
      onComplete: { gold: 500, item: { unique: 'riftplate' } } },
