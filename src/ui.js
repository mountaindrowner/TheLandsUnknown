...
(function (TLU) {
  ...
  function renderHUD(game) {
    ...
    html += '<div class="statrow">Stormlight</div>' + bar(p.stormlight, p.maxStormlight, '#7e6bff');
    ...
    html += '<div class="time">' + (game.storm && game.storm.active ? '⛈ HIGHSTORM' : '☀ Day ' + game.day) + '</div>';
    el.innerHTML = html;
  }
